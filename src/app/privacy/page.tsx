      ...
      <div className="max-w-none">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="text-muted-foreground mt-4 list-inside list-disc space-y-2">
              <li>
                With service providers who help us operate the service (for
                example, payment and hosting providers)
              </li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              sessions and to enhance your experience. You can control cookie
              settings through your browser preferences, though disabling them
              may affect sign-in.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Stripe for payments, Google OAuth for authentication, and Neon for
              database hosting. These providers have their own privacy policies,
